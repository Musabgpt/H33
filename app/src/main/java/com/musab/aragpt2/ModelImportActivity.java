 ...
 * The selected model stays where the user already has it; only its SAF URI is persisted.
 */
public final class ModelImportActivity extends Activity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        try {
            if (takeFlags != 0 && (data.getFlags() & Intent.FLAG_GRANT_PERSISTABLE_URI_PERMISSION) != 0) {
